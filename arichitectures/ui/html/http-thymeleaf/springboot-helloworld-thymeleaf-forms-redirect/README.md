...
##### Goal
The goal of this project is to present how to redirect from one **HTML** page with form to other **HTML** page with message in a **browser** using **Java** application with **Spring Boot** and **Thymeleaf** frameworks.
