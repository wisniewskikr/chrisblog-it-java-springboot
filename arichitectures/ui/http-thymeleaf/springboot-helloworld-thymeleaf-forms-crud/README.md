...
##### Goal
The goal of this project is to present how to implement **CRUD** operations (Create/Read/Update/Delete) and display results in a **browser** using **Java** application with **Spring Boot** and **Thymeleaf** frameworks.
