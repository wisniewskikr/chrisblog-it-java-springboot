...
1. In a command line tool build **Docker image BE** with `docker build -f fe-springboot-be-springboot-threads-no_BE/Dockerfile -t be-image:0.0.1 ./fe-springboot-be-springboot-threads-no_BE`
...
1. In a command line tool build **Docker image FE** with `docker build -f fe-springboot-be-springboot-threads-no_FE/Dockerfile -t fe-image:0.0.1 ./fe-springboot-be-springboot-threads-no_FE`
...
##### Optional steps:
1. In a command line tool build Docker BE image with `docker build -f fe-springboot-be-springboot-threads-no_BE/Dockerfile -t wisniewskikr/fe-springboot-be-springboot-threads-no_be:0.0.1 ./fe-springboot-be-springboot-threads-no_BE`
1. In a command line tool push Docker BE image to Docker Repository with `docker push wisniewskikr/fe-springboot-be-springboot-threads-no_be:0.0.1` 
1. In a command line tool build Docker FE image with `docker build -f fe-springboot-be-springboot-threads-no_FE/Dockerfile -t wisniewskikr/fe-springboot-be-springboot-threads-no_fe:0.0.1 ./fe-springboot-be-springboot-threads-no_FE`
1. In a command line tool push Docker FE image to Docker Repository with `docker push wisniewskikr/fe-springboot-be-springboot-threads-no_fe:0.0.1` 
