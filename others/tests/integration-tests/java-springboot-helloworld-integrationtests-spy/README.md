...
##### Goal
The goal of this project is to present how to create **Integration Tests** with **Spy annotation** for an application type **API REST** in **Java** programming language with usage **Spring Boot** framework.
...
* **Spy Annotation**: annotation Spy is hybrid. It combines both: real methods and mock methods
