...
##### Goal
The goal of this project is to present how to use **Stream** method **map()** to create the **copy** of objects in an application type **API REST** in **Java** programming language with usage **Spring Boot 3** framework.
