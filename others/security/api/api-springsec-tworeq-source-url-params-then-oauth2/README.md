...
**In first request** credentials are sent as **URL Parameters**. **Authentication** is done manually by developer in **controller**. As a result **Access Token** type **JWT (JSON Web Token)** is sent.
