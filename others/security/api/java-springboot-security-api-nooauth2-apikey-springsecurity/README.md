...
1. Send GET request with Postman (**API Key Authentication** with credentials **user / user123** or **admin / admin123**) to URL `http://localhost:8080/user`
1. Send GET request with Postman (**API Key Authentication** with credentials **admin / admin123**) to URL `http://localhost:8080/admin`
