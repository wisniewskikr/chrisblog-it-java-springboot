...
##### Goal
The goal of this project is to present how to create **Minikube** Kubernetes **Depoyment** with **two replicas** and **healthcheck** for simple "Hello World" **Java** application with **Spring Boot** framework using **Kubernetes** tool. 
...
* **Download** source code and open any **Command Line** tool on **project's folder**. You can do it in following way:
    ...
    * Go to source code folder with `cd chrisblog-it\java-orchestration-kubernetes\springboot-kubernetes-deployment-replicas-healthcheck`
