...
##### Goal
The goal of this project is to present how to create **Minikube** Kubernetes **Service** in type **ClusterIP** for simple "Hello World" **Java** application with **Spring Boot** framework using **Kubernetes** tool. 
...
* **Download** source code and open any **Command Line** tool on **project's folder**. You can do it in following way:
    ...
    * Go to source code folder with `cd java-orchestration-kubernetes-minikube\springboot-kubernetes-service-clusterip`
