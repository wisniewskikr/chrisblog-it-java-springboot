...
public class PartSuite extends ParentRunner<Runner> {
    ...
    private static Class<?>[] filterClasses(Class<?>[] classes, boolean filterEnabled) {
        ...
        PartFilterClass filterClass = new PartFilterClass();
        ...
        PartSpringRunner.filterClass = filterClass;
    ...
    private static boolean isValidClass(Class<?> cl, PartFilterClass classNames) {
