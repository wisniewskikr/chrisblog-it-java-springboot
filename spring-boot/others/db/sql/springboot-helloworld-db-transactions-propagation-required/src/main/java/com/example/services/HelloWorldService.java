...
public class HelloWorldService {
	...
	@Transactional
	public void saveTextWithErrorTransactionPropagationRequired(String helloText, String worldText) {
		
		helloService.saveText(ERROR_TRANSACTION_HELLO_ENTITY_ID, helloText);		
		worldService.saveTextWithErrorTransactionPropagationRequired(ERROR_TRANSACTION_WORLD_ENTITY_ID, worldText).getId();
