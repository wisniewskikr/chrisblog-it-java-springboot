...
public class HelloWorldController {
	...
	public HelloWorldJson helloWorld() {		
		...
		String description = "Method saveSentence(Hello, World) calls two methods: saveFirstWord(Hello) and saveSecondWord(World). "
				+ "There is an exception in saveSecondWord(World) which is transactional and marked as Propagation.SUPPORTS. "
				+ "But because first method is not transactional then operations ARE NOT rolled back. That's why sentence from database is: 'Hello World'";
